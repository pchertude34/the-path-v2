        ...
        for (let provider of providers) {
          ...
          try {
            ...
            if (googlePlaceIds.data?.candidates[0]) {
              ...
              const location = `POINT(${lat}, ${lng})::geometry`;
              var query1 = `INSERT INTO provider VALUES (${id}, '${placeId}', '${name}', ${location}, ${undisclosed}, '${address}', '${city}', '${state}', '${website}', '${email}', '${description}');`;
              ...
              services.forEach(async (service) => {
                try {
                  var query2 = `INSERT INTO service_on_provider VALUES (${id}, '${service}')`;
